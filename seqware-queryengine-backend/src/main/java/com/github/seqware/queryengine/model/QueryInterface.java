...
//    public void setAnalysisPluginACL(ACL acl, AnalysisPlugin analysisPlugin);
     ...
     * @return 
     */
    public <ReturnValue> QueryFuture<ReturnValue> getFeaturesByPlugin(int hours, Class<? extends PluginInterface> pluginClass, Reference reference, List<FeatureSet> set, Object... parameters);
