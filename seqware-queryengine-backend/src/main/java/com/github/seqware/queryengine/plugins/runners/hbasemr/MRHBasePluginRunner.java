...
//    			System.out.println(stopPos);
           ...
           Filter rowFilter = new RowFilter(CompareFilter.CompareOp.GREATER, new RegexStringComparator("hg_19smallTestOverlapAndNormal.1:hg_19smallTestOverlapAndNormal.1:000000000000000"));
