...
/**
 * This plug-in runner implements the instantiation and running of an arbitrary
 * input dumper plugin class.
 *
 * @author bso
 * @version $Id: $Id
 */
public class ArbitraryPluginRunner {
    ...
    public static int runArbitraryPluginRunner(String[] args) {
        ...
        try {
            ...
            // System.exit not appropriate here when called via the web interface
            throw new RuntimeException("EXIT_CODE_INVALID_ARGS");
