...
public class InMemoryGroup extends AbstractInMemorySet<Group, User> implements Group {
   ...
   * {@inheritDoc}
   *
   * Override the equals method for Group, kind of a cheat With other objects we
   * take into account things like version or SGID However, with Group, the
   ...
   * <p>newBuilder.</p>
   *
   * @return a {@link com.github.seqware.queryengine.model.Group.Builder}
   * object.
   */
