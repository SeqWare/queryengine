...
public class TaggableTest {
    ...
    public static void setupTests() {
        ...
        f2 = mManager.buildFeature().setSeqid("chr16").setStart(1000200).setStop(1000201).build();
        f3 = mManager.buildFeature().setSeqid("chr16").setStart(1000400).setStop(1000401).build();
        testFeatures.add(f1);
        testFeatures.add(f2);
        testFeatures.add(f3);
    ...
    public void testTagSetParentReferences() {
        ...
        Feature fe1 = mManager.buildFeature().setSeqid("chr16").setStart(1000000).setStop(1000001).build();
        Feature fe2 = mManager.buildFeature().setSeqid("chr16").setStart(1000200).setStop(1000201).build();
        Feature fe3 = mManager.buildFeature().setSeqid("chr16").setStart(1000400).setStop(1000401).build();
