...
public class FactoryStaticInitializerTest {
     ...
     static {
        ...
        a1 = mManager.buildFeature().setSeqid("chr16").setStart(1000000).setStop(1000101).build();
        a2 = mManager.buildFeature().setSeqid("chr16").setStart(1000200).setStop(1000301).build();
        a3 = mManager.buildFeature().setSeqid("chr16").setStart(1000400).setStop(1000501).build();
        aSet.add(a1);
        aSet.add(a2);
        aSet.add(a3);
        mManager.flush();
